 ...
 *
 * What it covers is the subset you actually use while fixing a twenty-line Python
 ...
 *
 * Ported from the Rust Handbook (github.com/madalintat/rust-handbook), MIT,
 * (c) 2026 Madalin Tatarciuc. The engine is language-agnostic: the only thing
 * that changed for Python is the line-comment token used by `gc`.
 */
...
/* gc, from Comment.nvim. Python line comments only, which is all this editor
