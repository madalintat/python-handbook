...
That top-level handler is the one legitimate use of a wide `except Exception:`, and even there it must log the traceback rather than swallow it, or you have moved the silence to a more expensive place.
